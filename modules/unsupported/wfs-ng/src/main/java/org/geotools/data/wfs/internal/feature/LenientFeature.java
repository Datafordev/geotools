 ...
 */
package org.geotools.data.wfs.internal.feature;
...
public class LenientFeature extends SimpleFeatureImpl {
    ...
    /**
     * Creates a new instance of flat feature, which must take a flat feature type schema and all
     * attributes as arguments.
     * 
     * @param schema
     *            Feature type schema for this flat feature.
     * @param attributes
     ...
     *             Attribtues do not conform to feature type schema.
    ...
    protected LenientFeature(List<Attribute> attributes, SimpleFeatureType schema, String featureID)
        ...
        super(preFix(attributes, schema), checkSchema(schema), SimpleFeatureBuilder
                .createDefaultFeatureIdentifier(featureID));
     ...
     * 
     * @throws IllegalAttributeException
     *             if the passed in val does not validate against the AttributeType at that
     *             position.
     */
    public void setAttribute(int position, Object val) throws IllegalAttributeException {
        ...
        try {
            ...
            try {
                ...
                if (constructing) {
                    LOGGER.logp(Level.WARNING, "LenientFeature", "setAttribute",
                            "Illegal Argument but ignored since we are being lenient", e);
                } else {
     ...
     * 
     * @param newAtts
     *            List of values in the correct order (may not be complete?)
     ...
     *             If some contents are not cloneable.
     */
    public Object clone() {
        try {
