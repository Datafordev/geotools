 ...
 */
package org.geotools.data.wfs.internal.v1_0_0.legacy;
...
import org.geotools.data.wfs.internal.v1_0_0.legacy.WFSSchema.WFSAttribute;
import org.geotools.data.wfs.internal.v1_0_0.legacy.WFSSchema.WFSComplexType;
import org.geotools.data.wfs.internal.v1_0_0.legacy.WFSSchema.WFSElement;
...
public class WFSCapabilitiesComplexTypes {
    /**
     * <p>
     * This class represents an SchemaDescriptionLanguageType within the WFS Schema. This includes
     * both the data and parsing functionality associated with a SchemaDescriptionLanguageType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class SchemaDescriptionLanguageType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = { new WFSElement("XMLSCHEMA",
                EmptyType.getInstance(), 1, Integer.MAX_VALUE, false, null) };
    ...
    /**
     * <p>
     * This class represents an EmptyType within the WFS Schema. This includes both the data and
     * parsing functionality associated with a EmptyType.
     * </p>
     * 
     * @see WFSComplexType
     */
    ...
    /**
     * <p>
     * This class represents an ResultFormatType within the WFS Schema. This includes both the data
     * and parsing functionality associated with a ResultFormatType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class ResultFormatType extends WFSComplexType {
        ...
        private static final Element[] elements = {
                new WFSElement("GML2", EmptyType.getInstance(), 1, 1, false, null),
                new WFSElement("GML2-GZIP", EmptyType.getInstance(), 0, 1, false, null),
                new WFSElement("GML2-ZIP", EmptyType.getInstance(), 0, 1, false, null) };
    ...
    /**
     * <p>
     * This class represents an OperationsType within the WFS Schema. This includes both the data
     * and parsing functionality associated with a OperationsType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class OperationsType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("Insert", EmptyType.getInstance(), 1, 1, false, null),
                new WFSElement("Update", EmptyType.getInstance(), 1, 1, false, null),
                new WFSElement("Delete", EmptyType.getInstance(), 1, 1, false, null),
                new WFSElement("Query", EmptyType.getInstance(), 1, 1, false, null),
                new WFSElement("Lock", EmptyType.getInstance(), 1, 1, false, null), };
    ...
    /**
     * <p>
     * This class represents an MetadataURLType within the WFS Schema. This includes both the data
     * and parsing functionality associated with a MetadataURLType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class MetadataURLType extends WFSComplexType {
        ...
        private static Attribute[] attributes = {
                new WFSAttribute("type", new SimpleTypeGT(null, null, WFSSchema.NAMESPACE,
                        SimpleType.RESTRICTION,
                        new SimpleType[] { XSISimpleTypes.NMTOKEN.getInstance() }, new Facet[] {
                                new FacetGT(Facet.ENUMERATION, "TC211"),
                                new FacetGT(Facet.ENUMERATION, "FGDC") }, SimpleType.NONE),
                        Attribute.REQUIRED),
                new WFSAttribute("format", new SimpleTypeGT(null, null, WFSSchema.NAMESPACE,
                        SimpleType.RESTRICTION,
                        new SimpleType[] { XSISimpleTypes.NMTOKEN.getInstance() }, new Facet[] {
                                new FacetGT(Facet.ENUMERATION, "XML"),
                                new FacetGT(Facet.ENUMERATION, "SGML"),
                                new FacetGT(Facet.ENUMERATION, "TXT") }, SimpleType.NONE),
                        Attribute.REQUIRED) };
    ...
    /**
     * <p>
     * This class represents an LatLonBoundingBoxType within the WFS Schema. This includes both the
     * data and parsing functionality associated with a LatLonBoundingBoxType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class LatLongBoundingBoxType extends WFSComplexType {
        ...
        // static element list
        private static Attribute[] attributes = {
                new WFSAttribute("minx", XSISimpleTypes.String.getInstance(), Attribute.REQUIRED),
                new WFSAttribute("miny", XSISimpleTypes.String.getInstance(), Attribute.REQUIRED),
                new WFSAttribute("maxx", XSISimpleTypes.String.getInstance(), Attribute.REQUIRED),
                new WFSAttribute("maxy", XSISimpleTypes.String.getInstance(), Attribute.REQUIRED) };
    ...
    /**
     * <p>
     * This class represents an PostType within the WFS Schema. This includes both the data and
     * parsing functionality associated with a PostType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class PostType extends WFSComplexType {
        ...
        private static Attribute[] attributes = { new WFSAttribute("onlineResource",
    ...
    /**
     * <p>
     * This class represents an HTTPType within the WFS Schema. This includes both the data and
     * parsing functionality associated with a HTTPType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class HTTPType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("Get", GetType.getInstance(), 0, Integer.MAX_VALUE, false, null),
                new WFSElement("Post", PostType.getInstance(), 0, Integer.MAX_VALUE, false, null) };
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs, Map hints)
            ...
            for (int i = 0; i < value.length; i++) {
                if ((value[i].getElement() != null)
                        && value[i].getElement().getName().equals(elements[0].getName())) {
                    // get
                    c.setGet((URL) value[i].getValue());
                }

                if ((value[i].getElement() != null)
                        && value[i].getElement().getName().equals(elements[1].getName())) {
                    // post
    ...
    /**
     * <p>
     * This class represents an GetType within the WFS Schema. This includes both the data and
     * parsing functionality associated with a GetType.
     * </p>
     * 
     * @see WFSComplexType
     */
    ...
    /**
     * <p>
     * This class represents an FeatureTypeType within the WFS Schema. This includes both the data
     * and parsing functionality associated with a FeatureTypeType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class FeatureTypeType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("Name", XSISimpleTypes.QName.getInstance(), 1, 1, false, null),
                new WFSElement("Title", XSISimpleTypes.String.getInstance(), 0, 1, false, null),
                new WFSElement("Abstract", XSISimpleTypes.String.getInstance(), 0, 1, false, null),
                new WFSElement("Keywords", XSISimpleTypes.String.getInstance(), 0, 1, false, null),
                new WFSElement("SRS", XSISimpleTypes.String.getInstance(), 1, 1, false, null),
                new WFSElement("Operations", OperationsType.getInstance(), 0, 1, false, null),
                new WFSElement("LatLongBoundingBox", LatLongBoundingBoxType.getInstance(), 0,
                        Integer.MAX_VALUE, false, null),
                new WFSElement("MetadataURL", MetadataURLType.getInstance(), 0, Integer.MAX_VALUE,
                        false, null) };
                                            ...
                                            if (elements[7].getName().equals(
                                                ...
                                                throw new SAXException(
                                                        "Unknown child element within a FeatureTypeType: "
                                                                + ((value[i].getElement().getName() == null) ? "null"
                                                                        : value[i].getElement()
                                                                                .getName()));
                                            }
                                        }
    ...
    /**
     * <p>
     * This class represents an DCPTypeType within the WFS Schema. This includes both the data and
     * parsing functionality associated with a DCPTypeType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class DCPTypeType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = { new WFSElement("HTTP", HTTPType.getInstance(),
                1, 1, false, null) };
    ...
    /**
     * <p>
     * This class represents an LockFeatureTypeType within the WFS Schema. This includes both the
     * data and parsing functionality associated with a LockFeatureTypeType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class LockFeatureTypeType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = { new WFSElement("DCPType",
                DCPTypeType.getInstance(), 1, Integer.MAX_VALUE, false, null) };
    ...
    /**
     * <p>
     * This class represents an RequestType within the WFS Schema. This includes both the data and
     * parsing functionality associated with a RequestType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class RequestType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("GetCapabilities", GetCapabilitiesType.getInstance(), 1, 1, false,
                        null),
                new WFSElement("DescribeFeatureType", DescribeFeatureTypeType.getInstance(), 1, 1,
                        false, null),
                new WFSElement("Transaction", TransactionType.getInstance(), 1, Integer.MAX_VALUE,
                        false, null),
                new WFSElement("GetFeature", GetFeatureTypeType.getInstance(), 1, 1, false, null),
                new WFSElement("GetFeatureWithLock", GetFeatureTypeType.getInstance(), 1, 1, false,
                        null),
                new WFSElement("LockFeature", LockFeatureTypeType.getInstance(), 1, 1, false, null) };
                                ...
                                if (elements[3].getName().equals(value[i].getElement().getName())) {
                                    ...
                                    if (elements[4].getName().equals(
                                        ...
                                        if (elements[5].getName().equals(
                                            ...
                                            // error
                                            throw new SAXException("Unknown child element "
                                                    + value[i].getElement().getName()
    ...
    /**
     * <p>
     * This class represents an ServiceType within the WFS Schema. This includes both the data and
     * parsing functionality associated with a ServiceType .
     * </p>
     * 
     * @see WFSComplexType
     */
    static class ServiceType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("Name", XSISimpleTypes.String.getInstance(), 1, 1, false, null),
                new WFSElement("Title", XSISimpleTypes.String.getInstance(), 1, 1, false, null),
                new WFSElement("Abstract", XSISimpleTypes.String.getInstance(), 0, 1, false, null),
                new WFSElement("Keywords", XSISimpleTypes.String.getInstance(), 0, 1, false, null),
                new WFSElement("OnlineResource", XSISimpleTypes.AnyURI.getInstance(), 1, 1, false,
                        null),
                new WFSElement("Fees", XSISimpleTypes.String.getInstance(), 0, 1, false, null),
                new WFSElement("AccessConstraints", XSISimpleTypes.String.getInstance(), 0, 1,
                        false, null) };
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs, Map hints)
            ...
            if ((service.getName() == null) || (service.getTitle() == null)
                ...
                throw new SAXException("Required Service Elements are missing, check"
    ...
    /**
     * <p>
     * This class represents an FeatureTypeListType within the WFS Schema. This includes both the
     * data and parsing functionality associated with a FeatureTypeListType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class FeatureTypeListType extends WFSComplexType {
        ...
        private static final Element[] elements = {
                new WFSElement("Operations", OperationsType.getInstance(), 0, 1, false, null),
                new WFSElement("FeatureType", FeatureTypeType.getInstance(), 1, Integer.MAX_VALUE,
                        false, null) };
    ...
    /**
     * <p>
     * This class represents an CapabilityType within the WFS Schema. This includes both the data
     * and parsing functionality associated with a CapabilityType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class CapabilityType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("Request", RequestType.getInstance(), 1, 1, false, null),
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs, Map hints)
            ...
            // check the required elements
            if (capab[1] == null) {
                throw new SAXException("Required Capability Element is missing, check"
    ...
    /**
     * <p>
     * This class represents an WFS_CapabilitiesType within the WFS Schema. This includes both the
     * data and parsing functionality associated with an WFS_CapabilitiesType .
     * </p>
     * 
     * @see WFSComplexType
     */
    static class WFS_CapabilitiesType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("Service", ServiceType.getInstance(), 1, 1, false, null),
                new WFSElement("Capability", CapabilityType.getInstance(), 1, 1, false, null),
                new WFSElement("FeatureTypeList", FeatureTypeListType.getInstance(), 1, 1, false,
                        null),

                new WFSElement("Filter_Capabilities", Filter_CapabilitiesType.getInstance(), 1, 1,
                        false, null) {
                    /**
        ...
        private static final Attribute[] attributes = {
                new WFSAttribute("version", XSISimpleTypes.String.getInstance(),
                        Attribute.REQUIRED, "1.0.0"),
                new WFSAttribute("updateSequence", XSISimpleTypes.NonNegativeInteger.getInstance(),
            ...
            if (element != null) {
                if (element.getType() != this) {
                    if (!(element.getType() instanceof ComplexType)) {
                        ...
                        while ((t != null) && (t != this))
                            t = (t.getParent() instanceof ComplexType) ? (ComplexType) t
                                    .getParent() : null;
                            ...
                            if (elements[3].getName().equals(value[i].getElement().getName())) {
                                ...
                                if (validation) {
                                    ...
                                    throw new SAXException("The element "
                                            + ((value[i].getElement() == null) ? "null" : value[i]
                                                    .getElement().getName())
    ...
    /**
     * <p>
     * This class represents an GetCapabilitiesType within the WFS Schema. This includes both the
     * data and parsing functionality associated with a GetCapabilitiesType.
     * </p>
     * 
     * @see WFSComplexType
     */
    ...
    /**
     * <p>
     * This class represents an DescribeFeatureType within the WFS Schema. This includes both the
     * data and parsing functionality associated with a DescribeFeatureType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class DescribeFeatureTypeType extends WFSComplexType {
        ...
        private static final Element[] elements = {
                new WFSElement("SchemaDescriptionLanguage",
                        SchemaDescriptionLanguageType.getInstance(), 1, 1, false, null),
                new WFSElement("DCPType", DCPTypeType.getInstance(), 1, Integer.MAX_VALUE, false,
                        null) };
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs, Map hints)
            ...
            for (int i = 0; i < value.length; i++) {
                if ((sdl == null) && (value[i].getElement() != null)
                        && "SchemaDescriptionLanguage".equals(value[i].getElement().getName())) {
    ...
    /**
     * <p>
     * This class represents an GetFeatureTypeType within the WFS Schema. This includes both the
     * data and parsing functionality associated with a GetFeatureTypeType.
     * </p>
     * 
     * @see WFSComplexType
     */
    static class GetFeatureTypeType extends WFSComplexType {
        ...
        // static element list
        private static final Element[] elements = {
                new WFSElement("ResultFormat", ResultFormatType.getInstance(), 1, 1, false, null),
                new WFSElement("DCPType", DCPTypeType.getInstance(), 1, Integer.MAX_VALUE, false,
                        null) };
