...
public class WFSBasicComplexTypes {
        ...
        public void encode(Element element, Object value, PrintHandler output, Map hints)
            ...
            if (canEncode(element, value, hints)) {
                ...
                attributes.addAttribute(WFSSchema.NAMESPACE.toString(), attrs[2].getName(), null,
                        "string", attrs[2].getFixed());

                Query query = (Query) value;

                if ((query != null) && (query.getMaxFeatures() != Query.DEFAULT_MAX)) {
                    attributes.addAttribute(WFSSchema.NAMESPACE.toString(), attrs[3].getName(),
    ...
    static class DescribeFeatureTypeType extends WFSComplexType {
        ...
        private static Element[] elems = new Element[] { new WFSElement("TypeName",
                XSISimpleTypes.QName.getInstance(), 0, Integer.MAX_VALUE, false, null), };
    ...
    static class QueryType extends WFSComplexType {
        ...
        private static Attribute[] attrs = new Attribute[] {
                ...
                new WFSAttribute("featureVersion", XSISimpleTypes.String.getInstance(),
                        Attribute.OPTIONAL) };
        ...
        public void encode(Element element, Object value, PrintHandler output, Map hints)
            ...
            if (canEncode(element, value, hints)) {
                ...
                if ((query.getHandle() != null) && !"".equals(query.getHandle())) {
                    attributes.addAttribute(WFSSchema.NAMESPACE.toString(), attrs[0].getName(),
                            null, "string", query.getHandle());
                }

                // TODO this is a QName I think ... check it out
                attributes.addAttribute(WFSSchema.NAMESPACE.toString(), attrs[1].getName(), null,
                        "string", query.getTypeName());

                try {
                    if ((query.getVersion() != null) && !"".equals(query.getVersion())) {
                        attributes.addAttribute(WFSSchema.NAMESPACE.toString(), attrs[2].getName(),
                                null, "string", query.getVersion());
                    }
                } catch (Throwable t) {
                    // ...
                }
                ...
                if (Filter.INCLUDE != query.getFilter()) {
                    if ((query.getFilter() != null)
                            && elems[1].getType().canEncode(elems[1], query.getFilter(), hints)) {
    ...
    static class FeatureCollectionType extends WFSComplexType {
         ...
         */
        public Attribute[] getAttributes() {
            return new Attribute[] { new AttributeGT(null, "lockId", WFSSchema.NAMESPACE,
