...
public class WFS_2_0_0_ParsingTest extends TestCase {
    ...
    public void _testParseGetCapabilities() throws Exception {
        ...
        Object parsed = parser.parse(resourceAsStream);
    ...
    private void assertOperationsMetadataDeeGree(WFSCapabilitiesType caps) {
        ...
        List<OperationType> operation = om.getOperation();
        assertEquals(6, operation.size());

        OperationType getCapsOp = operation.get(2);
        ...
        assertEquals("GetFeature", ((OperationType) operation.get(0)).getName());
        assertEquals("DescribeFeatureType", ((OperationType) operation.get(1)).getName());
        assertEquals("GetFeatureWithLock", ((OperationType) operation.get(3)).getName());
        assertEquals("LockFeature", ((OperationType) operation.get(4)).getName());
        assertEquals("Transaction", ((OperationType) operation.get(5)).getName());
    }
    ...
    void assertFeatureTypeList(WFSCapabilitiesType caps) {
        ...
        EList<WGS84BoundingBoxType> wgs84BoundingBox = featureType.getWGS84BoundingBox();
    ...
    public void _testParseGetFeature() throws Exception {
        ...
        List<FeatureCollection> featureCollections = fc.getMember();
